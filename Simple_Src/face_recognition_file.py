...
def getfeat_github(net,img):
    ...
    out = net.forward()
    print "net output shape is ", net.blobs['fc5'].data[0].shape
...
##########################################
#fileRes = r'/home/peterhou/FaceRecognition/Testdata/liuhe_Caffe.txt'
...
def drawrec(minkey,minscore,img,d,video_name):
    ...
    cv2.putText(img,minkey,(d.left()+sidebar,d.top()-sidebar*20),font,1,color,1,False)
    cv2.putText(img,'%2f'%(minscore),(d.left()+sidebar,d.top()-sidebar*10),font,1,color,1,False)
    cv2.putText(img,video_name,(d.left()+sidebar,d.top()-sidebar*15),font,1,(255,0,0),1,False)
...
#clt_pca = joblib.load('../Jb/'+"pca_model.pkl")

saveMeanPath = '/home/peterhou/FaceRecognition/Jb/mean.mat'
saveCompoTPath = '/home/peterhou/FaceRecognition/Jb/compoT.mat'
...
#out = cv2.VideoWriter("liuhe.avi", fourcc, 4.0, (1024,768))
  
if __name__ == '__main__':
    testvideo_path = '/home/peterhou/FaceRecognition/e1e4/'
    #testvideo_path = '/home/peterhou/vic/data/videos/facevideos/'
    files= os.listdir(testvideo_path)
    #anspath='/home/peterhou/vic/data/videos/myout/'
    anspath = '/home/peterhou/FaceRecognition/facevideosout/'
    fourcc = cv2.VideoWriter_fourcc(*"MPEG")
    #  fps = capture.get(cv2.CAP_PROP_FPS)
    fileRes = r'result_e1e4.txt'
    ...
    for filename in files:
        ...
        try:
            ...
            continue
        out = cv2.VideoWriter(filename, fourcc, 4.0, (1024,768))
        with open(fileRes,'a+') as fr:
            fr.write(filename +'\r')
        num = 1
        while capture.read():
        ...
        #cv2.imshow('Face Verification',img)
            ...
            if isinstance(img, types.NoneType):
                ...
                for k, d in enumerate(dets):
                    ...
                    with open(fileRes,'a+') as fr:
                        fr.write('No. '+ str(num-1) +' anskey = '+str(minkey)+'  minscore = '+str(minscore)+'\r')
