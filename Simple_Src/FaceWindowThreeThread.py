...
class MainWindow(QWidget):
    def __init__(self, qFace, qList1):#, playtimerOut, facetimerOut, texttimerOut, databasetimerOut):
...
class FaceTimer(QThread):
    def __init__(self, qFace = Queue.Queue(4), signal = "updateTime", 
                        qList1 = Queue.Queue(4), parent=None):
...
class TextTimer(QThread):
    ...
    def __init__(self, qList1 = Queue.Queue(4), signal = "updateTime", parent=None):
...
if __name__ == '__main__':
    ...
    mainwindow = MainWindow(qFace, qList1)#,playtimerOut,facetimerOut,texttimerOut,databasetimerOut)
    mainwindow.show()
    sys.exit(app.exec_())