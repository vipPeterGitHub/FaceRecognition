...
class MainWindow(QWidget):
    def __init__(self, qFace, qList, qPost, qCapture, qSmallFace, qResult, terminateAll):
...
class ShowWindow(multiprocessing.Process):
    ...
    def run(self):
        ...
        mainwindow = MainWindow(self.qFace, self.qList,self.qPost,self.qCapture,self.qSmallFace,self.qResult,self.terminateAll)
        mainwindow.show()
        sys.exit(app.exec_())
...
if __name__ == '__main__':
    showwindow = ShowWindow(qFace,qList,qPost,qCapture,qSmallFace,qResult,terminateAll)
